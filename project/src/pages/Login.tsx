  ...
  const handlePasswordRecovery = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        setError(
          "Este email não foi confirmado. Verifique sua caixa de entrada para confirmar sua conta primeiro."
        );
        ...
        setError(
          "Problema temporário no envio de emails. Tente novamente em alguns minutos ou entre em contato com o suporte."
        );
      } else if (
        ...
        setError(
          `Erro ao enviar email de recuperação: ${errorMessage}. Tente novamente em alguns minutos.`
        );
      }
    } finally {
    ...
    <div className="fade-in">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-olive-50 via-gold-50 to-azure-50 rounded-2xl p-6 border-2 border-gold-300 shadow-xl mt-8">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-olive-800 italic text-lg mb-2">
