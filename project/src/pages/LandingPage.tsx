...
import { Leaf, Wallet, BookOpen, BarChart2, Heart, Target, Shield, Menu, X } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="bg-white shadow-lg border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-montserrat font-bold text-gray-800">ZoePlanner</span>
            </div>
            
            <div className="hidden md:flex items-center space-x-6">
              <a href="#features" className="text-gray-700 hover:text-olive-600 px-3 py-2 transition-colors duration-200">Recursos</a>
              <Link 
                to="/login" 
        ...
        <div className={`md:hidden ${mobileMenuOpen ? 'block' : 'hidden'}`}>
          <div className="pt-2 pb-4 space-y-1 px-4">
            <a href="#features" className="block px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100">Recursos</a>
            <Link 
              to="/login" 
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0 fade-in">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Planeje suas finanças com <span className="text-olive-600">propósito cristão</span>
              </h1>
              <p className="text-lg text-gray-700 mb-8">
                ZoePlanner une tecnologia moderna com princípios bíblicos para transformar
                sua relação com o dinheiro e ajudá-lo a ser um bom mordomo dos recursos que Deus confiou a você.
              </p>
      ...
      <section id="features" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Organização Financeira com Propósito</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              O ZoePlanner oferece ferramentas poderosas para gerenciar suas finanças
              de acordo com princípios bíblicos de mordomia e generosidade.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Visualize suas finanças com clareza através de gráficos intuitivos e relatórios detalhados que ajudam a entender seus hábitos financeiros.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Registre e categorize suas receitas e despesas de forma simples, mantendo o controle completo do seu fluxo financeiro.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Acompanhe seus dízimos, ofertas e votos com ferramentas especiais para promover a fidelidade na mordomia cristã.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">Metas com Propósito</h3>
              <p className="text-gray-600">
                Estabeleça e acompanhe metas financeiras alinhadas com seus valores cristãos, sejam viagens missionárias ou projetos pessoais.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">Princípios Bíblicos</h3>
              <p className="text-gray-600">
                Receba orientações baseadas na Bíblia para cada aspecto da sua jornada financeira, ajudando a alinhar suas decisões com a Palavra.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">Planejamento Seguro</h3>
              <p className="text-gray-600">
                Proteja seu futuro financeiro com ferramentas de planejamento que incentivam decisões sábias e equilibradas.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-olive-600 py-12 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-xl md:text-2xl font-montserrat italic">
            "O que você faz com o que Deus te dá, define o que Ele pode confiar a você."
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-olive-600 to-olive-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">Comece sua jornada de mordomia hoje</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Junte-se a milhares de cristãos que estão transformando sua relação com as finanças
            através do ZoePlanner.
          </p>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-2xl font-montserrat font-bold">ZoePlanner</span>
              </div>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">© 2025 ZoePlanner. Todos os direitos reservados.</p>
