...
const TithingPage: React.FC = () => {
  ...
  const tithingPercentage =
    monthlyIncome > 0 ? (actualTithe / monthlyIncome) * 100 : 0;
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                Dízimos, Ofertas e Votos
              </h1>
              <p className="text-gray-700">
                Administre sua fidelidade financeira com propósito cristão
              </p>
            </div>
            <button
        ...
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Selecione o mês para análise de fidelidade
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {(() => {
              ...
              const quickOptions = [
                {
                  label: "Este Mês",
                  value: `${today.getFullYear()}-${String(
                    today.getMonth() + 1
                  ).padStart(2, "0")}`,
                  icon: Calendar,
                ...
                },
                {
                  ...
                  value: (() => {
                    ...
                    return `${twoMonthsAgo.getFullYear()}-${String(
                ...
                },
                {
                  ...
                  value: (() => {
                    ...
                    return `${threeMonthsAgo.getFullYear()}-${String(
              ...
              return quickOptions.map((option, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`h-8 w-8 rounded-full bg-gradient-to-br ${option.color} flex items-center justify-center mx-auto mb-2 shadow-lg`}
                    >
                      <IconComponent className="h-4 w-4 text-white" />
                    </div>
                    <p
                      className={`text-xs font-medium ${
                        isSelected ? "text-gold-800" : "text-gray-700"
                      }`}
                    >
                      {option.label}
                    </p>
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-sm">
                    <p className="font-medium text-gray-800">
                      📊 Analisando: {formatMonthName(selectedMonth)}
                    </p>
                    <p className="text-xs text-gray-600 mt-0.5">
                      {(() => {
                        const hasData = tithingRecords.some((r) =>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-olive-800">
                R$ {recommendedTithe.toLocaleString("pt-BR")}
              </span>
            </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-olive-800">
                R$ {actualTithe.toLocaleString("pt-BR")}
              </span>
            </div>
            ...
            {tithingPercentage < 10 && monthlyIncome > 0 && (
              <div className="flex items-center mt-2 p-2 bg-orange-100 rounded-lg">
                ...
                <span className="text-xs text-orange-700">
                  Faltam R${" "}
                  {(recommendedTithe - actualTithe).toLocaleString("pt-BR")}
                </span>
              </div>
            )}
          </div>
        ...
        <div className="card p-6 bg-gradient-to-br from-gold-50 to-gold-100 border-gold-200 hover:shadow-xl transition-all duration-300">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gold-600">
              Além dos dízimos, suas ofertas demonstram um coração generoso e
              amor ao próximo.
            </p>
            ...
            {totalOfferings > 0 && (
              <div className="mt-3 p-2 bg-gold-200 rounded-lg">
                <p className="text-xs text-gold-800 font-medium">
                  {((totalOfferings / monthlyIncome) * 100).toFixed(1)}% da
                  receita mensal
                </p>
              </div>
            )}
        ...
        <div className="card p-6 bg-gradient-to-br from-azure-50 to-azure-100 border-azure-200 hover:shadow-xl transition-all duration-300">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-azure-600">
              Seus votos representam compromissos especiais feitos diante de
              Deus.
            </p>
            ...
            {monthlyIncome > 0 && (
              <div className="mt-3 p-2 bg-purple-200 rounded-lg">
                <p className="text-xs text-purple-800 font-medium">
                  {((totalGiving / monthlyIncome) * 100).toFixed(1)}% da receita
                  total
                </p>
              </div>
            )}
      ...
      {showForm && (
        <div
          id="new-tithing-form"
          className="card p-6 bg-gradient-to-br from-white to-gray-50 border-2 border-gold-200 shadow-xl"
        >
        ...
        <div className="card p-6 bg-gradient-to-br from-white to-gray-50">
          <div className="flex items-center mb-4">
            ...
            <h2 className="section-title">
              Distribuição - {formatMonthName(selectedMonth)}
            </h2>
          </div>
            ...
            {givingData.length > 0 ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-gray-500">
                ...
                <p className="text-center">
                  Nenhuma contribuição registrada neste mês
                </p>
                <p className="text-sm text-center mt-1">
                  Comece registrando sua primeira contribuição
                </p>
              </div>
            )}
          </div>
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500">
                      {totalGiving > 0
                        ? ((item.value / totalGiving) * 100).toFixed(1)
                        : 0}
                      %
                    </p>
                  </div>
          ...
          <div className="h-64">
            {monthlyIncome > 0 ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-gray-500">
                ...
                <p className="text-sm text-center mt-1">
                  Registre receitas para ver a análise de fidelidade
                </p>
              </div>
            )}
          </div>
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="p-3 bg-gradient-to-r from-olive-50 to-olive-100 rounded-lg border border-olive-200">
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`font-bold ${
                      actualTithe >= recommendedTithe
                        ? "text-green-700"
                        : "text-red-700"
                    }`}
                  >
                    {actualTithe >= recommendedTithe ? "+" : ""}R${" "}
                    {(actualTithe - recommendedTithe).toLocaleString("pt-BR")}
                  </span>
                </div>
              </div>
            </div>
        ...
        {sortedRecords.length > 0 ? (
          <div className="space-y-3">
            {sortedRecords.map((record) => (
              <div
                key={record.id}
                className="group bg-white border border-gray-200 rounded-xl p-4 hover:shadow-lg hover:border-gold-300 transition-all duration-300"
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4 flex-1 min-w-0">
                    ...
                    >
                      ...
                      {record.type === "vow" && (
                        <Target className="h-5 w-5 text-azure-600" />
                      )}
                    </div>
                  ...
                  <div className="flex items-center space-x-3 ml-4">
                    <div className="text-right">
                      ...
                      {monthlyIncome > 0 && (
                        <p className="text-xs text-gray-500">
                          {((record.amount / monthlyIncome) * 100).toFixed(1)}%
                          da receita
                        </p>
                      )}
                    </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Comece registrando seus dízimos, ofertas e votos para acompanhar
              sua fidelidade financeira.
            </p>
            <button
              onClick={handleShowForm}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                Ser fiel nos dízimos e ofertas não é apenas sobre dinheiro, mas
                sobre confiar em Deus como nosso provedor e reconhecer que tudo
                o que temos vem dele. A Bíblia nos ensina que a fidelidade no
                pouco abre portas para fidelidade no muito.
              </p>
              ...
              {tithingPercentage >= 10 ? (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <p className="text-green-700 text-sm">
                    Você está honrando a Deus com suas finanças, mantendo a
                    fidelidade bíblica nos dízimos. Continue sendo um exemplo de
                    mordomia cristã.
                  </p>
                </div>
              ) : monthlyIncome > 0 ? (
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                  ...
                  <p className="text-orange-700 text-sm">
                    Lembre-se que o dízimo representa nossa gratidão e
                    reconhecimento de que tudo vem de Deus. Considere ajustar
                    gradualmente para alcançar os 10% recomendados.
                  </p>
                </div>
              ) : (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-blue-700 text-sm">
                    Registre suas receitas para acompanhar sua fidelidade nos
                    dízimos e crescer na mordomia cristã.
                  </p>
                </div>
              )}
              ...
              {totalOfferings > 0 && (
                <div className="bg-gold-50 border border-gold-200 rounded-lg p-4">
                  ...
                  <p className="text-gold-700 text-sm">
                    Suas ofertas demonstram um coração generoso. Continue
                    desenvolvendo esta virtude cristã que abençoa tanto quem dá
                    quanto quem recebe.
                  </p>
                </div>
              )}
